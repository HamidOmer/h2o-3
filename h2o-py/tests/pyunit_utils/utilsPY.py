...
def compare_frames_local(f1, f2, prob=0.5, tol=1e-6, returnResult=False):
    ...
    for colInd in range(f1.ncol):
        if (typeDict[frameNames[colInd]]==u'enum'):
            if returnResult:
                return compare_frames_local_onecolumn_NA_enum(f1[colInd], f2[colInd], prob=prob, tol=tol, returnResult=returnResult)
            else:
            ...
            if returnResult:
                return compare_frames_local_onecolumn_NA_string(f1[colInd], f2[colInd], prob=prob, returnResult=returnResult)
            else:
            ...
            if returnResult:
                return compare_frames_local_onecolumn_NA(f1[colInd], f2[colInd], prob=prob, tol=tol, returnResult=returnResult)
            else:
